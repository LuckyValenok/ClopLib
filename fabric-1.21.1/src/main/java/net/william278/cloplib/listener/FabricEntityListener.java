...
import net.william278.cloplib.mixins.ExplosionAccessor;
...
public interface FabricEntityListener extends FabricListener {
    ...
    @NotNull
    default Collection<BlockPos> onExplosionBreakBlocks(Explosion explosion, @Unmodifiable Collection<BlockPos> blockPos) {
        ...
        for (BlockPos pos : blockPos) {
            if (!getHandler().cancelOperation(Operation.of(
                    ...
                    getPosition(pos, ((ExplosionAccessor) explosion).getWorld())
            ))) {
                newList.add(pos);
            }
        }
